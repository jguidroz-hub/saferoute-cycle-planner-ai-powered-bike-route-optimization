...
const FROM = process.env.EMAIL_FROM || 'SafeRoute Cycle Planner - AI-powered bike route optimization <noreply@example.com>';
const APP_NAME = 'SafeRoute Cycle Planner - AI-powered bike route optimization';
