...
export default function FeaturePage() {
  const items = [
    { t: "Route A — Downtown (8 stops)", d: "Distance: 23 miles • Est. time: 2h 15m • Fuel: $8.50 • Optimized ✅", s: "optimized" },
    { t: "Route B — Suburbs (12 stops)", d: "Distance: 45 miles • Est. time: 3h 40m • Fuel: $16.20 • Can improve", s: "suboptimal" },
    { t: "Route C — Industrial (5 stops)", d: "Distance: 18 miles • Est. time: 1h 30m • Fuel: $6.40 • Optimized ✅", s: "optimized" },
    { t: "Tomorrows Plan", d: "3 routes • 25 total stops • Start: 8:00 AM • ETA finish: 4:30 PM", s: "planned" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <p className="text-gray-500 text-sm mb-6">Optimize routes for field operations</p>
