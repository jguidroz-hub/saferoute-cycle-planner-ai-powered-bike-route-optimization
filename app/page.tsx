  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">SafeRoute Cycle Planner - AI-powered bike route optimization</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Helps cyclists plan routes that prioritize safety, scenic beauty, and enjoyment over directness, leveraging AI to analyze road conditions, traffic data, and user preferences, reducing stress and improving ride quality for a better cycling experience.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust SafeRoute Cycle Planner - AI-powered bike route optimization.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} SafeRoute Cycle Planner - AI-powered bike route optimization. All rights reserved.</p>
